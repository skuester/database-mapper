...
describe ("DataView", function () {
	...
	it.skip ("TEST: works when the scope returns a simple value result", async function () {
		let query = DB.DataView({
			mapper: mapper.get('Person'),
	...
	it.skip("returns simple values for value methods like .count()", async function () {
		let query = DB.DataView({
			mapper: mapper.get('Person'),
			methods: {
				by_name(name) {
